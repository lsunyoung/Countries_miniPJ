...
class CummunityHeart: UIButton {

    /// 하트 이미지
    var checkBoxResouces = OnOffResources(
        onImage: UIImage(systemName: "heart.fill")?.withTintColor(.red).withRenderingMode(.alwaysOriginal), //#colorLiteral(
